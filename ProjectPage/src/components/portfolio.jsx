    ...
    <section id="portfolio" className="container">
      <div className="row">
        ...
        <div className="project" style={{ marginBottom: '50px', marginRight: '50px' }}>
            <img src="public/dashboard.png" alt="picture of weather app showing weather in boston" style={{ height: '350px' }} className="img-fluid" />
        ...
        <div className="col-md-6">
        <div className="project" style={{ marginBottom: '50px', marginRight: '50px' }}>
            <img src="public/scheduler.png" alt="picture of scheduler app from November 2023" style={{ height: '350px' }} className="img-fluid" />
        ...
        <div className="col-md-6">
        <div className="project" style={{ marginBottom: '50px', marginRight: '50px' }}>
            <img src="public/PourDecisions.png" alt="picture of culinarycanvas homepage" style={{ height: '350px' }} className="img-fluid" />
            <h3>PourDecisions</h3>
        ...
        <div className="col-md-6">
        <div className="project" style={{ marginBottom: '50px', marginRight: '50px' }}>
          <img src="public/recipe.png" alt="picture of recipe homepage" style={{ height: '350px' }} className="img-fluid" />
        ...
        <div className="col-md-6">
        <div className="project" style={{ marginBottom: '50px', marginRight: '50px' }}>
            <img src="public/testPage.png" alt="picture of timed test app" style={{ height: '350px' }} className="img-fluid" />
            <h3>Timed Test</h3>
        ...
        <div className="col-md-6">
        <div className="project" style={{ marginBottom: '50px', marginRight: '50px' }}>
            <img src="public/passwordGenerator.png" alt="picture of generator app" style={{ height: '350px' }} className="img-fluid" />
